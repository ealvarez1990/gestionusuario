                                ...
                                <div class="tab-pane active" id="horizontal-form">
                                    <form class="form-horizontal" method="post" action="phpeditar.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input  type="text" name="email" value="<?= $usuario->getEmail() ?>" class="form-control1" id="focusedinput" placeholder="Email">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputPassword" class="col-sm-2 control-label">Clave</label>
                                            <div class="col-sm-8">
                                                <input type="password" name="clave" value="<?= $usuario->getClave() ?>" class="form-control1" id="inputPassword" placeholder="Password" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputAlias" class="col-sm-2 control-label">Alias</label>
                                            <div class="col-sm-8">
                                                <input type="text" value="<?= $usuario->getAlias() ?>" name="alias" class="form-control1" id="inputAlias" placeholder="Password">
                                            </div>
                                        </div>

                                        <?php
                                        $fechayhora = $usuario->getFecha_alta();
